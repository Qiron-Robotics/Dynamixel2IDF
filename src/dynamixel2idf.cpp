...
#include "dynamixel2idf.h"

namespace DYNAMIXEL {

const uint16_t model_number_table[] = {
    AX12A,                AX12W,              AX18A,
...
Dynamixel2IDF::Dynamixel2IDF(uint16_t packet_buf_size)
: Master(2.0, packet_buf_size), model_number_idx_last_index_(0) {
  memset(&model_number_idx_, 0xff, sizeof(model_number_idx_));
}

Dynamixel2IDF::Dynamixel2IDF( uart_port_t port, int dir_pin, uint16_t packet_buf_size)
: Master(2.0, packet_buf_size), model_number_idx_last_index_(0) {
...
void Dynamixel2IDF::begin(unsigned long baud,  gpio_num_t txPin, gpio_num_t rxPin, uint32_t buf_size ) {
  p_dxl_port_ = (SerialPortHandler*)getPort();
  if(p_dxl_port_ == nullptr){
    setLastLibErrCode(D2A_LIB_ERROR_NULLPTR_PORT_HANDLER);
    return;
  }
  p_dxl_port_->begin( baud, txPin, rxPin, buf_size );
}

unsigned long Dynamixel2IDF::getPortBaud() {
  p_dxl_port_ = (SerialPortHandler*)getPort();
  if(p_dxl_port_ == nullptr){
    setLastLibErrCode(D2A_LIB_ERROR_NULLPTR_PORT_HANDLER);
    return 0;
...
bool Dynamixel2IDF::scan() {
  bool ret = true;
  ret = ping();
  return ret;
}

bool Dynamixel2IDF::ping(uint8_t id) {
  bool ret = false;
  if (id != DXL_BROADCAST_ID){
    InfoFromPing_t recv_info;
    if(Master::ping(id, &recv_info, 1, 10) < 0xFE ){
      if(recv_info.id == id){
...
bool 
Dynamixel2IDF::setModelNumber(uint8_t id, uint16_t model_number) {
  bool ret = false;
  if(id <= 253){
...
uint16_t Dynamixel2IDF::getModelNumber(uint8_t id) {
...
bool Dynamixel2IDF::setID(uint8_t id, uint8_t new_id) {
  return writeControlTableItem(ControlTableItem::ID, id, new_id);
}

bool Dynamixel2IDF::setProtocol(uint8_t id, float version) {
  uint8_t ver_idx;
  if(version == 1.0){
    ver_idx = 1;
  }else if(version == 2.0){
...
bool Dynamixel2IDF::setBaudrate(uint8_t id, uint32_t baudrate) {
...
/* Commands for Slave */
bool Dynamixel2IDF::torqueOn(uint8_t id) {
  return setTorqueEnable(id, true);
}

bool Dynamixel2IDF::torqueOff(uint8_t id) {
  return setTorqueEnable(id, false);
}

bool Dynamixel2IDF::setTorqueEnable(uint8_t id, bool enable) {
  return writeControlTableItem(ControlTableItem::TORQUE_ENABLE, id, enable);
}

bool Dynamixel2IDF::ledOn(uint8_t id) {
  return setLedState(id, true);
}

bool Dynamixel2IDF::ledOff(uint8_t id) {
  return setLedState(id, false);
}

bool Dynamixel2IDF::setLedState(uint8_t id, bool state) {
  bool ret = false;
  uint16_t model_num = getModelNumberFromTable(id);
  switch(model_num){
    // case PRO_L42_10_S300_R:
...
//TODO: Simplify the code by grouping model numbers.
bool Dynamixel2IDF::setOperatingMode(uint8_t id, uint8_t mode) {
  bool ret = false;
  uint16_t model_num = getModelNumberFromTable(id);
  switch(model_num){
    case AX12A:
...
int32_t Dynamixel2IDF::readControlTableItem(uint8_t item_idx, uint8_t id, uint32_t timeout) {
  int32_t ret = 0;
  uint16_t model_num = getModelNumberFromTable(id);
...
bool Dynamixel2IDF::writeControlTableItem(uint8_t item_idx, uint8_t id, int32_t data, uint32_t timeout) {
  bool ret = false;
  uint16_t model_num = getModelNumberFromTable(id);
  // To use the command function without ping() or model addition.
  if(model_num == UNREGISTERED_MODEL){
...
int32_t Dynamixel2IDF::readControlTableItem(uint16_t model_num, uint8_t item_idx, uint8_t id, uint32_t timeout) {
...
bool Dynamixel2IDF::writeControlTableItem(uint16_t model_num, uint8_t item_idx, uint8_t id, int32_t data, uint32_t timeout) {
  bool ret = false;
  ControlTableItemInfo_t item_info;
  p_dxl_port_ = (SerialPortHandler*)getPort();
  if(p_dxl_port_ == nullptr){
...
uint8_t
Dynamixel2IDF::getModelNumberIndex(uint16_t model_num) {
  uint8_t i, ret = 0xFF;
  // quick shortcut
...
uint16_t Dynamixel2IDF::getModelNumberFromTable(uint8_t id) {
  uint8_t idx;
  uint16_t model_num;
  if(id > 254){
    setLastLibErrCode(DXL_LIB_ERROR_INVAILD_ID);
...
float Dynamixel2IDF::readForRangeDependencyFunc(uint8_t func_idx, uint8_t id, uint8_t unit) {
  float ret = 0;
  int32_t recv_data = 0;
  uint16_t model_num = getModelNumberFromTable(id);
...
bool Dynamixel2IDF::writeForRangeDependencyFunc(uint8_t func_idx, uint8_t id, float value, uint8_t unit) {
  bool ret = false;
  int32_t data = 0;
  uint16_t model_num = getModelNumberFromTable(id);
  ItemAndRangeInfo_t item_info;
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ctable_1_0_common[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ex[] = {
...
/* MX(1.0) series */
const ModelDependencyFuncItemAndRangeInfo_t dependency_ctable_1_1_common[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_mx12[] = {
#if (ENABLE_ACTUATOR_MX12W)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_mx64_mx106[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xl320[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ctable_2_0_common[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_mx64_2[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_mx106_2[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xl330_M288_M077[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xl430_xc430[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xc330_m181_m288[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xc330_t181_t288[] = {
#if (ENABLE_ACTUATOR_XC330)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xm430_w210_w350[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xh430_wt210_wt350[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xw430_t200_t333[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xh430_v210_v350[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xm540_xh540_xt540_xw540[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_xh540_v150_v270[] = {
...
/* PRO R series */
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_r_m42_10[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_r_m54_40[] = {
#if (ENABLE_ACTUATOR_PRO_R)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_r_m54_60[] = {
#if (ENABLE_ACTUATOR_PRO_R)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483647, 2147483647, 0.00143188},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483647 , 2147483647,  0.00143188},
  {SET_VELOCITY, GOAL_VELOCITY, UNIT_RPM, -8000, 8000, 0.00397746},
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_r_h42_20[] = {
#if (ENABLE_ACTUATOR_PRO_R)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_r_h54_100[] = {
#if (ENABLE_ACTUATOR_PRO_R)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_r_h54_200[] = {
#if (ENABLE_ACTUATOR_PRO_R)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483647, 2147483647, 0.00071724},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483647 , 2147483647, 0.00071724},
  {SET_VELOCITY, GOAL_VELOCITY, UNIT_RPM, -17000, 17000, 0.00199234},
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ctable_pro_ra_pro_plus_model[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_ra_plus_m42_10[] = {
#if (ENABLE_ACTUATOR_PRO_RA || ENABLE_ACTUATOR_PRO_PLUS)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_ra_plus_m54_40[] = {
#if (ENABLE_ACTUATOR_PRO_RA || ENABLE_ACTUATOR_PRO_PLUS)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_ra_plus_m54_60[] = {
#if (ENABLE_ACTUATOR_PRO_RA || ENABLE_ACTUATOR_PRO_PLUS)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483647, 2147483647, 0.00071594},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483647 , 2147483647, 0.00071594},
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_ra_plus_h42_20[] = {
#if (ENABLE_ACTUATOR_PRO_RA || ENABLE_ACTUATOR_PRO_PLUS)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_ra_plus_h54_100[] = {
#if (ENABLE_ACTUATOR_PRO_RA || ENABLE_ACTUATOR_PRO_PLUS)
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_pro_ra_plus_h54_200[] = {
#if (ENABLE_ACTUATOR_PRO_RA || ENABLE_ACTUATOR_PRO_PLUS)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483647, 2147483647, 0.00035862},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483647 , 2147483647, 0.00035862},
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ym070_210_000_rh[] = {
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ym070_210_051_rh[] = {
#if (ENABLE_ACTUATOR_Y)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483648, 2147483647, 0.0006866455},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483648 , 2147483647, 0.0006866455},
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ym070_210_099_rh[] = {
#if (ENABLE_ACTUATOR_Y)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483648, 2147483647, 0.0006866455},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483648 , 2147483647, 0.0006866455},
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ym080_230_000_rh[] = {
#if (ENABLE_ACTUATOR_Y)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483648, 2147483647, 0.0006866455},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483648 , 2147483647, 0.0006866455},
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ym080_230_051_rh[] = {
#if (ENABLE_ACTUATOR_Y)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483648, 2147483647, 0.0006866455},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483648 , 2147483647, 0.0006866455},
...
const ModelDependencyFuncItemAndRangeInfo_t dependency_ym080_230_099_rh[] = {
#if (ENABLE_ACTUATOR_Y)
  {SET_POSITION, GOAL_POSITION, UNIT_DEGREE, -2147483648, 2147483647, 0.0006866455},
  {GET_POSITION, PRESENT_POSITION, UNIT_DEGREE, -2147483648 , 2147483647, 0.0006866455},
